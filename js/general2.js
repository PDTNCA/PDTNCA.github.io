...
/*
     FILE ARCHIVED ON 18:23:00 Dec 24, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 17:02:25 May 13, 2016.
...
function format_twitter_message(str){
	...
	str = str.replace(/([^\w])\@([\w\-]+)/gm,'$1@<a href="/web/20141224182300/http://twitter.com/$2" target="_blank">$2</a>');
	str = str.replace(/([^\w])\#([\w\-]+)/gm,'$1<a href="/web/20141224182300/http://twitter.com/search?q=%23$2" target="_blank">#$2</a>');
	return str;
}
